...
export function SessionSummaryCard({ sessionDate, summary, trainerName }: Props) {
  return (
    <section aria-labelledby="session-summary-heading" className="bg-card rounded-2xl p-4 shadow-sm">
      <h2
        id="session-summary-heading"
        className="text-hint mb-2 text-xs font-semibold tracking-wide uppercase"
      >
        Session Summary
      </h2>
